                                ...
                                <div class="col-md-3"></div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <form class="row" action="update_request_status_bcode.php" method="POST">
                                                 

                                                <div class="col-md-12">
                                                    <div class="form-floating">
                                                        <select class="form-select  " name="status" id="floatingSelect" aria-label="Floating label select example"  style="background: transparent; border: none; border-bottom: 2px solid rgb(227, 231, 236);">
                                                        <option selected>Select</option>
                                                        <option>Viewed</option>
                                                        <option>Accepted</option>
                                                        <option>Rejected</option>
                                                        <option>Delivered to Department</option>
                                                ...
                                                <div class="col-12" style="align-items: center; padding:10px 40%;">
