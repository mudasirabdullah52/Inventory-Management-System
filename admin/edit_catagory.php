                         ...
                         <div class="row">
                             <div class="col-md-3"></div>
                                <div class="col-md-6 col-xs-12">
                                    <form action="update_catagory.php" method="post" class="form-container shadow-lg p-3 mb-5 bg-body rounded"  >
                                    ...
                                    <div class="form-floating mb-3">
                                                ...
                                                <label for="floatingInput" style="color: blue;">catagory id:</label>
                                            </div>
                                    

                                        <div class="form-floating mb-3">
                                                <input type="text" name="catagory" class="form-control" id="floatingInput" value="<?php echo $cat;?>"  style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
...
<?php
	...
	// 	$connection = mysqli_connect("localhost","root","");
	// 	$db = mysqli_select_db($connection,"inventory");
	// 	$query = "update add_catagory set catagory = '$_POST[catagory]' where cat_id = $_GET[cid]";
	// 	$query_run = mysqli_query($connection,$query);
