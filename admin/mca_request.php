                    ...
                    <div class="row">
                            ...
                            <div class="col-md-10">
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                        <td colspan="10" style="color:yellow; background-color:green; text-align: center;"><?php echo $_SESSION['department'];?> PRODUCT LIST</td>
                                        </tr>
                                        <tr>
                                            <!-- <th>P. Id</th> -->
                                            <th>Dept.</th>
                                    ...
                                    <?php
                                        ...
                                        $query = "select * from request where department = 'MCA'";
                                        ...
                                        while($row = mysqli_fetch_assoc($query_run)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-success" name=""><a style="text-decoration: none; color: white;" href="../report.php?cid=<?php echo $row['id'];?>">Report</a></button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger" name=""><a style="text-decoration: none; color: white;" href="update_request_status.php?cid=<?php echo $row['id'];?>">Update  </a></button>
                                                </td>
                                            </tr>
                                            <?php
                                        }
