...
<head>
    ...
    document.getElementById("num3").value = x * y;
    }
    </script>
    <style>
        .nav{
                         ...
                         <div class="col-md-12">
                             <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="text-center" style="font-family: 'Texturina', serif; color:gold">wellcome</h3>
                                ...
                                <div class="col-md-1"></div>
                                    <div class="col-md-10">
                                        <div class="card">
                                            ...
                                            <form class="row" action="update_product_bcode.php" method="POST">
                                                <div class="col-md-6">  
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="price"  value="<?php echo $price;?>" class="form-control  " id="num1"   placeholder="Enter Address" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                                        <label for="floatingInput" style="color: red; font-size: 20px;">Price</label>
                                                    </div>
                                                </div>

                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="quantity"  value="<?php echo $quantity;?>" class="form-control" onkeyup="add()"  id="num2"   placeholder="Enter Address" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="total"  value="<?php echo $total;?>" class="form-control  " id="num3"   placeholder="Enter Address" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                                        <label for="floatingInput" style="color: red; font-size: 20px;">Total</label>
                                                    </div>
                                                </div>
