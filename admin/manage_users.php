                    ...
                    <div class="row">
                            ...
                            <div class="col-md-10">
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                        <td colspan="10" style="color:yellow; background-color:green; text-align: center;">LIST OF ALL THE USERS</td>
                                        </tr>
                                        <tr>
                                            <th>P. Id</th>
                                            <th>Name.</th>
                                    ...
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($query_run)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-success" name=""><a style="text-decoration: none; color: white;" href="edit_users_profile.php?cid=<?php echo $row['id'];?>">Edit</a></button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger" name=""><a style="text-decoration: none; color: white;" href="delete_users_profile.php?cid=<?php echo $row['id'];?>">Delete</a></button>
                                                </td>
                                            </tr>
                                            <?php
                                        }
