                    ...
                    <div class="card-body" style="margin:10px; padding:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-10  form-container">
                                ...
                                <form class="row" action="update_profile_bcode.php" method="POST">

                                
                                    <!-- <div class="col-md-4">
                                        <div class="form-floating mb-3">
                                            <input readonly type="text" name="id" class="form-control text-success" id="floatingInput"value="<?php echo $id;?>" placeholder="name@example.com" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                            <label for="floatingInput" style="color: red; font-size: 20px;">profile Id:</label>
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input readonly type="password" name="password" class="form-control text-success" id="floatingPassword" value="<?php echo $password;?>" placeholder="Password" style="background: transparent; border: none; border-bottom: 2px solid rgb(227, 231, 236);">
