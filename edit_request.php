                                ...
                                <div class="col-md-1"></div>
                                    <div class="col-md-10">
                                        <div class="card">
                                            ...
                                            <form class="row" action="update_request_bcode.php" method="POST">
                                                <div class="col-md-6">  
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input  readonly type="text" name="hod_name"  value="<?php echo $_SESSION['name'];?>" class="form-control" id="floatingPassword"  placeholder="Enter Phone Number" style="background: transparent; border: none; border-bottom: 2px solid rgb(227, 231, 236);">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input readonly type="email" name="email"  value="<?php echo $_SESSION['email'];?>"class="form-control " id="floatingInput"  placeholder="Enter Name" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input readonly type="text" name="phone"  value="<?php echo $_SESSION['phone'];?>" class="form-control  " id="floatingPassword"  placeholder="Password" style="background: transparent; border: none; border-bottom: 2px solid rgb(227, 231, 236);">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        ...
                                                        <option selected> <?php echo $catagory;?></option>
                                                            <?php
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="quantity"  value="<?php echo $quantity;?>" class="form-control  " id="floatingInput"   placeholder="Enter Address" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
