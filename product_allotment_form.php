        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body" style="margin:20px; padding:20px;" class="p-3 border bg-light">
                     
                         <div class="row">
                                <div class="col-md-1"></div>
                                    <div class="col-md-10">
                                        <div class="card">
                                            <div class="card-header text-center">Product Allotment Form</div>
                                            <form class="row" action="product_allotment_form_bcode.php" method="POST" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        <label for="floatingInput" style="color: red; font-size: 20px;">Faculity Name</label>
                                                    </div>
                                                </div>
