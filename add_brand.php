                         ...
                         <div class="row">
                             <!-- <div class="col-md-3"></div> -->
                                <div class="col-md-6 col-xs-12">
                                    <form action="add_brand_bcode.php" method="post" class="form-container  shadow-lg p-3 mb-5 bg-body rounded"  >
                                         

                                        <div class="form-floating mb-3">
                                                <input type="text" name="brand" class="form-control" id="floatingInput" placeholder="Enter Name" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                        ...
                                        <?php
                                            ...
                                            while($row = mysqli_fetch_assoc($query_run)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-success" name=""><a style="text-decoration: none; color: white;"  href="edit_brand.php?cid=<?php echo $row['id'];?>">Edit</a></button>
                                                    </td>
                                                    <td>
                                                        <button class="btn btn-danger" name=""><a style="text-decoration: none; color: white;"  href="delete_brand.php?cid=<?php echo $row['id'];?>">Delete</a></button>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
