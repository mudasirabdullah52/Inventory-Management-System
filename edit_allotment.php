...
if (!$name) {
	...
	$id = $_GET['cid'];
	$query = "select * from  allotment_list where id =  $id";
                ...
                <div class="card">
                    ...
                    <div class="row">
                                <div class="col-md-1"></div>
                                    <div class="col-md-10">
                                        <div class="card">
                                            <div class="card-header text-center">Update Allotment</div>
                                            <form class="row" action="update_allotment_bcode.php" method="POST">
