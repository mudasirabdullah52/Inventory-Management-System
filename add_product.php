                                ...
                                <div class="col-md-1"></div>
                                    <div class="col-md-10">
                                        <div class="card">
                                            ...
                                            <form class="row" action="add_product_bcode.php" method="POST">
                                                <div class="col-md-6">  
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="price" class="form-control  " id="num1"   placeholder="Enter Address" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="quantity" class="form-control  " id="num2" onkeyup="add()"  placeholder="Enter Address" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                                        <label for="floatingInput" style="color: red; font-size: 20px;">Quantity</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="total" class="form-control  " id="num3"   placeholder="Enter Address" style="background: transparent;  border: none; border-bottom: 2px solid rgb(227, 231, 236);" >
                                                        <label for="floatingInput" style="color: red; font-size: 20px;">Total Price</label>
                                                    </div>
                                                </div>
