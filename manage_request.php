                                    ...
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($query_run)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-success" name=""><a  style="text-decoration: none; color: white;" href="edit_request.php?cid=<?php echo $row['id'];?>">Edit</a></button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger" name=""><a style="text-decoration: none; color: white; " href="delete_request.php?cid=<?php echo $row['id'];?>">Delete</a></button>
                                                </td>
                                            </tr>
                                            <?php
                                        }
